 ...
 */
class getVotesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VotesRepository' shared autowired service.
     *
     * @return \App\Repository\VotesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VotesRepository.php';

        return $container->privates['App\\Repository\\VotesRepository'] = new \App\Repository\VotesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
