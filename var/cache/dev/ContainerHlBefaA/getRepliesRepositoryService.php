 ...
 */
class getRepliesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RepliesRepository' shared autowired service.
     *
     * @return \App\Repository\RepliesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RepliesRepository.php';

        return $container->privates['App\\Repository\\RepliesRepository'] = new \App\Repository\RepliesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
