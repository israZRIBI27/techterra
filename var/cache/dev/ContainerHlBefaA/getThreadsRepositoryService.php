 ...
 */
class getThreadsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ThreadsRepository' shared autowired service.
     *
     * @return \App\Repository\ThreadsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ThreadsRepository.php';

        return $container->privates['App\\Repository\\ThreadsRepository'] = new \App\Repository\ThreadsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
