...
class getTexter_TransportsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['texter.transports'] = (new \Symfony\Component\Notifier\Transport(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['notifier.transport_factory.twilio'] ?? $container->load('getNotifier_TransportFactory_TwilioService'));
            yield 1 => ($container->privates['notifier.transport_factory.null'] ?? $container->load('getNotifier_TransportFactory_NullService'));
        }, 2)))->fromStrings(['twilio' => $container->getEnv('TWILIO_DSN')]);
    }
}
